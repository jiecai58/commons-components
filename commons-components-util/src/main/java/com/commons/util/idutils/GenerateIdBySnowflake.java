 ...
 * @author caijie
 */
public class GenerateIdBySnowflake {

    public GenerateIdBySnowflake() {
    }
     ...
     */
    public GenerateIdBySnowflake(long workerId) {
     ...
     */
    public GenerateIdBySnowflake(long datacenterId, long workerId) {
    ...
    public static long generatId() {
        GenerateIdBySnowflake idWorker = new GenerateIdBySnowflake(0, 0);
