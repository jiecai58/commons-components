...
import com.statemachine.Transition;
import com.statemachine.impl.StateHelper;
import com.statemachine.impl.TransitionType;
...
public class TransitionsBuilderImpl<S,E,C> extends TransitionBuilderImpl<S,E,C> implements ExternalTransitionsBuilder<S,E,C> {
    ...
    @Override
    public com.statemachine.builder.When<S, E, C> when(Condition<C> condition) {
